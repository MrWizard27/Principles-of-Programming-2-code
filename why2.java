...
public static void main(String[] args) {
      ...
      String str = input.nextLine();
        ...
        switch (str) {
          ...
          switch (f2) {
          default:
          System.out.print("Thats not one of the 6 option, Tip: You can just type the number of the option if you don't want to type the whole thing. ie. 6 or Option 6");
          System.exit(0);
          break;
          case "attack":
          case "Attack":
          ...
          case "six":
          case "Six":
          System.out.print("You pop your favorite song into a boombox and start jamming, The sheer vibes and dances moves is enough to shatter the bears sense of reality\nThe bear runs into the forest unaware of where it is or who it really is");
          System.out.print("You have defeated the bear,\nOnwards");
          break;
          }
          System.out.println("");
          System.out.println("");
